...
3.  다음의 \[**사용자**]키가 등록되어 있는지 확인합니다.
    ...
    |       **대개방**  |       **소개방**    | **수동가압**   |
    | :--------------------------------------: | :--------------------------------------: | :--------------------------------------: |
    | ![](<../.gitbook/assets/image (86).png>) | ![](<../.gitbook/assets/image (16).png>) | ![](<../.gitbook/assets/image (43).png>) |


4.  “\[**SHIFT**]와 \[**사용자**]”키를 동시에 누르면 다음의 동작을 수행합니다. 멀티건이 선택된 경우 모든 건이 동일하게 동작합니다.
