...
The Data Backup function is used when you want to back up the welder’s configuration data to the Hi6 controller.
...
- ② When you want to modify the data of another welder connected to the Hi6 controller

- ③ When you want to apply batch updates to welders connected to another Hi6 controller